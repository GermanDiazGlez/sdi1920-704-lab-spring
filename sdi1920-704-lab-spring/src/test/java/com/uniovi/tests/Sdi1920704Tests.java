...
public class Sdi1920704Tests {
	...
	public void PR05() {
		...
		PO_RegisterView.fillForm(driver, "77777779A", "Josefo", "Perez", "77777", "77777");
	...
	public void PR06() {
		...
		//Comprobamos el error de Contraseñas demasiado cortas .
		PO_RegisterView.checkKey(driver, "Error.signup.password.length",
		PO_Properties.getSPANISH() );
		//Rellenamos el formulario.
		PO_RegisterView.fillForm(driver, "99999990B", "Josefo", "Perez", "77677", "77777");
	...
	//PRN. Identificación válida y desconexión con usuario de ROL usuario 99999990A/123456
	@Test
	public void PR11() {
		//Vamos al formulario de logueo.
		PO_HomeView.clickOption(driver, "login", "class", "btn btn-primary");
	...
	public void PR12() {
		// Login
		PO_PrivateView.login(driver, "btn btn-primary", "99999990A", "123456", "text", "Notas del usuario");
		...
		PO_PrivateView.logout(driver, "text", "Identifícate");
	}
	...
	public void PR14() {
		// Login
		PO_PrivateView.login(driver, "btn btn-primary", "99999993D", "123456", "text", "99999993D");
